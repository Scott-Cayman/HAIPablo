...
export function Button({
  ...
  const variants = {
    primary: 'bg-accent text-accent-foreground hover:opacity-90 focus:ring-accent shadow-sm',
    secondary: 'bg-secondary text-secondary-foreground border border-border hover:bg-muted focus:ring-border',
